...
**Версия платформы:** **Glyph 2.3-O** (Senza MI + Search + Obsidian) · **Репозиторий:** [FlokeStudio/Glyph-MI](https://github.com/FlokeStudio/Glyph-MI)  
...
*Floke Studio · правки документации — только здесь · Senza: `docs/GLYPH.md` (ссылка)*
